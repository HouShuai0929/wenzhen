...
import { ref } from 'vue'
import KonwledgeList from './components/KnowledgeList.vue'
  ...
  <div class="home-page">
    ...
    <van-tabs v-model:active="active" shrink sticky>
      <van-tab title="关注" name="like">
        ...
        <KonwledgeList type="like"></KonwledgeList
      ></van-tab>
      <van-tab title="推荐" name="recommend"
        ><KonwledgeList type="recommend"></KonwledgeList
      ></van-tab>
      <van-tab title="减脂" name="fatReduction"
        ><KonwledgeList type="fatReduction"></KonwledgeList
      ></van-tab>
      <van-tab title="饮食" name="food"
        ><KonwledgeList type="food"></KonwledgeList
      ></van-tab>
    </van-tabs>
  </div>
</template>
